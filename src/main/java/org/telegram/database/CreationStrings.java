...
public class CreationStrings {
    ...
    //public static final String createVersionTable = "CREATE TABLE IF NOT EXISTS Versions(ID INTEGER PRIMARY KEY AUTOINCREMENT, Version INTEGER);";
...
/*
    public static final String createRecentWeatherTable = "CREATE TABLE IF NOT EXISTS RecentWeather (ID INTEGER PRIMARY KEY AUTOINCREMENT, userId INTEGER NOT NULL, " +
            "date TIMESTAMP DEFAULT CURRENT_TIMESTAMP, cityId INTEGER NOT NULL, cityName VARCHAR(60) NOT NULL," +
...
/*
    public static final String createWeatherAlertTable = "CREATE TABLE IF NOT EXISTS WeatherAlert (id INTEGER PRIMARY KEY AUTOINCREMENT, userId INTEGER NOT NULL, cityId INTEGER NOT NULL, " +
